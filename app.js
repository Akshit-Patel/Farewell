...
function previous() {
  ...
  if (w < 600) {
    if (farewell.details.name1[currentEvent] === "Amritanshu") {
      name1.style.fontSize = "6vh";
      name1.style.marginTop = "10px";
      name2.style.fontSize = "6vh";
      name2.style.marginBottom = "10px";
    }
    else {
      name1.style.fontSize = "8vh";
      name1.style.marginTop = "0px"
      name2.style.fontSize = "8vh";
      name2.style.marginBottom = "10px";
    }
  } else {
    if (farewell.details.name1[currentEvent] === "Amritanshu") {
      name1.style.fontSize = "4vw";
      name1.style.marginTop = "20px";
      name2.style.fontSize = "4vw";
      name2.style.marginBottom = "20px";
    }
    else {
      name1.style.fontSize = "5vw";
      name1.style.marginTop = "0px";
      name2.style.fontSize = "5vw";
      name2.style.marginBottom = "0px";
    }
  }
